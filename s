		...
		local function GetElements(ItemParent)
			...
			function ElementFunction:AddToggleColorPicker(ToggleColorPickerConfig)
				...
				if ToggleColorPicker.Value then
					...
					ToggleCircle.Position = UDim2.new(0, PADDING, 0, PADDING)
				end				local ColorpickerBox = AddThemeObject(SetChildren(SetProps(MakeElement("RoundFrame", Color3.fromRGB(255, 255, 255), 0, 4), {
					Size = UDim2.new(0, 24, 0, 24),
				...
				end)				AddConnection(Click.MouseButton1Click, function()
				...
				end)				local function UpdateColorPicker()
				...
				UpdateHSV()AddConnection(Color.InputBegan, function(input)
					if input.UserInputType == Enum.UserInputType.MouseButton1 then
						if ColorInput then
				...
				end)				AddConnection(Hue.InputBegan, function(input)
					if input.UserInputType == Enum.UserInputType.MouseButton1 then
						if HueInput then
							HueInput:Disconnect()
						end;
				...
				end)				function ToggleColorPicker:Set(Value)

...
function ElementFunction:AddDropdown(DropdownConfig)
    ...
    if DropdownConfig.Multi then
        ...
        elseif type(DropdownConfig.Default) == "string" and DropdownConfig.Default ~= "" then
            if table.find(DropdownConfig.Options, DropdownConfig.Default) then
    ...
    local function GetSelectedText()
        if DropdownConfig.Multi then
            ...
            elseif #Dropdown.Value == 1 then
                ...
                return tostring(#Dropdown.Value) .. " Selected"
            end
        else
    ...
    if DropdownConfig.ToolTip and DropdownConfig.ToolTip ~= "" then
        AddTooltipToElement(DropdownFrame, DropdownConfig.ToolTip)
    end

            ...
            function Page:AddPage(g)
                ...
                function Group:Add3DPreviewWidget(o)
                    ...
                    local function getFramingBounds(m)
                        ...
                        local ok, c2, s2 = pcall(function()
                            local c, s = m:GetBoundingBox()
                            return true, c, s
                        end)
                        if ok and c2 and s2 then
                            return c2, s2
                        end
                        return nil
                    end
                    ...
                    local function rebuild()
                        ...
                        pcall(function()
                            local rp = getCharacterRoot(clone) or clone:FindFirstChild("Head")
                        ...
                        state.rootPart = getCharacterRoot(clone) or clone:FindFirstChild("Head")

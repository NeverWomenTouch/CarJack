                ...
                function Group:AddColorpicker(o)
                    ...
                    local function openPanel(btnFor, index)
                        ...
                        if not panel then
                            ...
                            hueSlider = Create("Frame", {Active = true, BackgroundTransparency = 0, BackgroundColor3 = Color3.fromRGB(255,255,255), BorderSizePixel = 0, Size = UDim2.fromOffset(HUE_W, HUE_H), Position = UDim2.fromOffset(10, 0), ZIndex = rightCol.ZIndex + 1, Parent = rightCol}, {Create("UICorner", {CornerRadius = UDim.new(0,4)}), Create("UIStroke", {Color = Theme.Stroke, Thickness = 1, Transparency = 0.3})})
                            ...
                            local cbRow = Create("TextButton", {BackgroundTransparency = 1, AutoButtonColor = false, Text = "", Size = UDim2.fromOffset(32, 22), Position = UDim2.fromOffset(178, 160), ZIndex = leftCol.ZIndex + 1, Parent = leftCol})
                            ...
                            Create("TextLabel", {BackgroundTransparency = 1, Size = UDim2.fromOffset(18,22), Position = UDim2.fromOffset(14,0), Text = "RGB", Font = Fonts.Medium, TextSize = 10, TextColor3 = Theme.SubText, TextXAlignment = Enum.TextXAlignment.Left, ZIndex = cbRow.ZIndex + 1, Parent = cbRow})

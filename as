            ...
            local slider = {
                ...
                set = function(self, val)
                    if type(val) == "number" or type(val) == "string" then
                        ...
                        IsSettingFromConfig = true
                        UpdateSlider(val)
                        IsSettingFromConfig = false
                        
                        self.value = precise and tonumber(string.format("%.1f", val)) or math.floor(val)
...
tab:Button("Load Config", function()
    ...
    for flag, val in pairs(data.values) do
        ...
        if library.flags[flag] then
            ...
            task.spawn(function()
                pcall(function()
                    if type(element) == "table" and typeof(element.set) == "function" then
                        -- Handle sliders (simple numeric values)
                        ...
                        elseif type(val) == "table" and val.__type == "Color3" then
                            ...
                            -- Handle rainbow state separately
                            if val.__rainbow ~= nil and typeof(element.setRainbow) == "function" then
                                task.delay(0.1, function()
                                    element:setRainbow(val.__rainbow)
                                end)
                            end
                        ...
                        elseif type(val) == "table" and val.__type == "Keybind" then
                            ...
                            if keyEnum then
                                element:set(keyEnum)
                                -- For KeybindT, also handle toggle state
                                if element.toggle and val.value == true then
                                    element:toggle()
                                end
                            end
                            ...
                            -- General case for all other element types

...
function library:Window(title, version, info, preset, closebind)
    ...
    function tabhold:Tab(text)
        ...
        function tabcontent:NewSlider(text, low, high, precise, callback, default, flag)
            ...
            hitbox.Position = UDim2.new(0, -10, 0, -15)
            hitbox.Size = UDim2.new(1, 20, 0, 35)
            hitbox.ZIndex = 10
            ...
            library.Conn[#library.Conn + 1] = hitbox.InputEnded:Connect(endDrag)
            library.Conn[#library.Conn + 1] = bar.InputBegan:Connect(startDrag)
            library.Conn[#library.Conn + 1] = bar.InputEnded:Connect(endDrag)
...
function tabcontent:Colorpicker(text, preset, callback, flag)
                ...
                RainbowSpeedHitbox.Position = UDim2.new(0, 0, 0.5, -10)
                RainbowSpeedHitbox.Size = UDim2.new(1, 0, 0, 20)
                ...
                local position = math.clamp((library.RainbowRegistry.speed - 0.1) / 2.9, 0, 1)
                ...
                library.Conn[#library.Conn + 1] = RainbowSpeedHitbox.InputBegan:Connect(handleSpeedInput)
                library.Conn[#library.Conn + 1] = RainbowSpeedSliderBar.InputBegan:Connect(handleSpeedInput)

    ...
    do -- Components
            ...
            local Items = { } do
                ...
                for Index = 1, Page.Columns do 
                    local NewColumn = Instances:Create("ScrollingFrame", {
                        ...
                        BackgroundTransparency = 1,
                        Size = UDim2New(1/Page.Columns, -4*(Page.Columns-1)/Page.Columns, 1, 0),
                        BackgroundColor3 = FromRGB(255, 255, 255),
                        BorderColor3 = FromRGB(0, 0, 0),
                        BorderSizePixel = 0,
        ...
        Library.Pages.AddSection = function(self, Data)
            ...
            if type(Data) == "string" then
                ...
                Section.Name = Data.Name or Data.name or "Section"
                Section.Description = Data.Description or Data.description or ""
                Section.Side = Data.Side or Data.side or 1
            end

            local Items = { } do 
                -- Create Content frame for the section
                Items["Content"] = Instances:Create("Frame", {
                    Name = "\0",
                    BackgroundTransparency = 1,
                    Size = UDim2New(1, 0, 1, 0),
                ...
                Items["Section"] = Instances:Create("Frame", {
                    Parent = Section.Page.ColumnsData[Section.Side] and Section.Page.ColumnsData[Section.Side].Instance or Section.Page.Items["Content"].Instance,
                    Name = "\0",
                    Size = UDim2New(1, 0, 0, 35),
                    BorderColor3 = FromRGB(0, 0, 0),
                    BorderSizePixel = 0,
        ...
        Library.Sections.AddParagraph = function(self, Name, Description)
            if not self or not self.Items or not self.Items["Content"] or not self.Items["Content"].Instance then
                return nil
            end
...
end -- end for the Library do block

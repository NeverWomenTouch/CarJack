...
do
    ...
    local function createWatermark()
        ...
        -- PRECISE cursor-locked dragging system
        ...
        watermarkFrame.InputBegan:Connect(function(input)
            if input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch then
                ...
                local framePos = watermarkFrame.AbsolutePosition
        ...
        UserInputService.InputChanged:Connect(function(input)
            ...
            if input.UserInputType == Enum.UserInputType.MouseMovement or input.UserInputType == Enum.UserInputType.Touch then
                ...
                -- Screen boundaries (using viewport size which accounts for insets)
                ...
                -- Apply position instantly for smooth dragging
    ...
    function Category:AddSection(p)
            ...
            function Page:AddPage(g)
                ...
                function Group:AddKeybind(o)
                    ...
                    box.MouseButton2Click:Connect(function()
                        ...
                        local function createModeItem(modeText, isSelected)
                            ...
                            local underline = Create("Frame", {BackgroundColor3 = Theme.Accent, BorderSizePixel = 0, Size = UDim2.new(0, isSelected and 1 or 0, 0, 2), AnchorPoint = Vector2.new(0,1), Position = UDim2.new(0,0,1,-2), Parent = btn})
                            if isSelected then
                                T(underline, 0.2, {Size = UDim2.new(0.8, 0, 0, 2)}):Play()
                            end
                ...
                function Group:AddKeybindToggle(o)
                    ...
                    local keybindToggleState = false -- Track toggle state for Toggle mode
                    local connections = {}
